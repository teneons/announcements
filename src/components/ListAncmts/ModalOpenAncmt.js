...
class ModalOpenAncmt extends Component {
  constructor(props) {
    super(props)
  ...
  componentDidUpdate(prevPrps) {
    if(this.props.propsID !== prevPrps.propsID){
      this.props.getIdByProps(this.props.propsID)
    
      this.props.ancmtState.map((item)=>{
        this.setState({
          id: item.id,
          title: item.title,
          date: item.date,
  ...
  render() {
    ...
    const outModal = this.props.ancmtState.map((item) => {
      return(
      <div className="modal fade" id="modalOpen" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" key={item.id}>
    ...
    return (
     <div className="modal fade" id="modalOpen" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" key={this.state.id}>
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header bg-warning">
              <h5 className="modal-title fs-4 fw-bold" id="exampleModalLabel">
                ...
                <span className='text-white'>{this.state.title}</span>
              </h5>
              <button type="button" className="btn-close" data-dismiss="modal" aria-label="Close"></button>
            </div>
            <div className="modal-body">
              ...
              <p>
                ...
                <span className='fw-bold'>{this.state.contact}</span>
              </p>
            </div>
          </div>
        </div>
