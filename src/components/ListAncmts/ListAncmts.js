          ...
          {this.props.ancmtsStore.map((ancmt) =>
            <div className="accordion-item" key={ancmt.id}>
              <h2 className="accordion-header" id="flush-headingOne">
                <button className="accordion-button collapsed fw-bold bg-warning" type="button" data-toggle="collapse" data-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
              ...
              <div id="flush-collapseOne" className="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-parent="#accordionFlushExample">
                ...
                <button type="button" className="btn btn-danger" onClick={() => this.removeItem(ancmt.id)}>
