      ...
      <div className='container mt-4 col-sm-12 col-md-8 col-lg-5 shadow p-3'>
        <div className="accordion accordion-flush" id="accordionFlushExample">
          {this.props.ancmtsStore.map((ancmt) =>
            ...
            <div className="accordion-item" key={ancmt.id}>
              <h2 className="accordion-header" id="flush-headingOne">
                <button className="accordion-button collapsed fw-bold bg-warning text-white" type="button" data-toggle="collapse" data-target={'#'+ancmt.id} aria-expanded="false" aria-controls="flush-collapseOne">
                  <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" className="bi bi-info-square mr-1 text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div id={ancmt.id} className="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-parent="#accordionFlushExample">
                ...
                <div className="accordion-body">
                  <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" className="bi bi-receipt mr-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="accordion-body">
                  <svg width="1.2em" height="1.2em" viewBox="0 0 16 16" className="bi bi-person-square mr-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" d="M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z" />
                ...
                <div className="d-flex justify-content-center">
                  <button type="button" className="btn btn-danger mr-2" onClick={() => this.removeItem(ancmt.id)}>
                    <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                      <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" />
                      <path fillRule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z" />
                    </svg>
                  </button>
                  <button type="button" className="btn btn-dark" data-toggle="modal" data-target="#modalControl">
              ...
              <ModalControlAncmt key={ancmt.id} title={ancmt.title}  date={ancmt.date} description={ancmt.description} contact={ancmt.contact} />
            </div>
          )}
...
export default connect(
  ...
  dispatch => ({
    removeAncmt: (id) => {
      dispatch({ type: 'REMOVE_ANCMT', payload: id })
    }
  })
)(ListAncmt)