  ...
  render() {
    ...
    return (
      <div className='container mt-4 col-sm-12 col-md-8 col-lg-5 shadow p-3'>
          ...
          {this.props.ancmtsStore.map((ancmt) =>
            <li className="list-group-item" key={ancmt.id}>
              ...
              <div className="btn-group float-right" role="group" aria-label="Basic example"> 
                  <button type="button" onClick={() => this.openItem(ancmt.id)} className="btn btn-outline-warning btn-sm" data-toggle="modal" data-target="#modalOpen">
        ...
        <ModalOpenAncmt propsID={this.state.id} />
        <ModalControlAncmt />
      </div>
    )
  }
