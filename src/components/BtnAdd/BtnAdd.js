...
export default class BtnAdd extends Component {
  ...
  return (
    <div>
      <button type="button" className="btn btn-warning fw-bold text-white text-uppercase" data-toggle="modal" data-target="#ModalAdd">
      <svg width="1.7em" height="1.7em" viewBox="0 0 16 16" className="bi bi-clipboard-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
